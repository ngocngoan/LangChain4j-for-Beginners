...
> ```
> Bu, kursu tamamlamak için ihtiyaç duyduğunuz her şeyi çok daha hızlı bir indirme ile size sunar.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

# Yeni Başlayanlar için LangChain4j

LangChain4j ve Azure OpenAI GPT-5 ile temel sohbetten AI ajanlarına kadar AI uygulamaları oluşturmak için bir kurs.

**LangChain4j'ye yeni misiniz?** Temel terimler ve kavramlar için [Sözlüğe](docs/GLOSSARY.md) göz atın.
...
3. [Prompt Mühendisliği](02-prompt-engineering/README.md) - Etkili prompt tasarımını öğrenin
...
> **Not:** Bu eğitim hem GitHub Modelleri hem de Azure OpenAI kullanmaktadır. [Hızlı Başlangıç](00-quick-start/README.md) modülü GitHub Modelleri (Azure aboneliği gerektirmez) kullanırken, 1-5 modüller Azure OpenAI kullanmaktadır. Henüz yoksa [ÜCRETSİZ Azure hesabı](https://aka.ms/azure-free-account) ile başlayın.


## GitHub Copilot ile Öğrenme

Hızlıca kodlamaya başlamak için, bu projeyi GitHub Codespace içinde veya yerel IDE'nizde sağlanan devcontainer ile açın. Bu kursta kullanılan devcontainer, AI eşliğinde programlama için önceden yapılandırılmış GitHub Copilot ile birlikte gelir.

Her kod örneği, GitHub Copilot'a sorabileceğiniz önerilen soruları içerir. Anlayışınızı derinleştirmek için 💡/🤖 işaretlerine bakın:
...
Daha fazlasını öğrenmek ister misiniz? [Copilot for AI Paired Programming](https://aka.ms/GitHubCopilotAI) sayfasına göz atın.
...
<!-- CO-OP ÇEVİRMEN DİĞER KURSLAR BİTİŞ -->

## Yardım Alma

Tıkandığınızda veya AI uygulamaları geliştirme ile ilgili herhangi bir sorunuz olduğunda katılın:
...
**Feragatname**:  
Bu belge, AI çeviri hizmeti [Co-op Translator](https://github.com/Azure/co-op-translator) kullanılarak çevrilmiştir. Doğruluk için çaba sarf etmekle birlikte, otomatik çevirilerin hata veya yanlışlık içerebileceğinin farkında olunmalıdır. Orijinal belge, ana dilindeki haliyle yetkili kaynak olarak kabul edilmelidir. Kritik bilgiler için profesyonel insan çevirisi önerilir. Bu çevirinin kullanımı sonucunda oluşabilecek yanlış anlamalar veya yorum hatalarından sorumlu tutulmayız.
