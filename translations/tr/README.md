...
Temel sohbetten AI ajanlarına kadar LangChain4j ve Azure OpenAI GPT-5.2 ile AI uygulamaları geliştirmek için bir kurs.
...
2. [Giriş](01-introduction/README.md) - LangChain4j temel kavramlarını öğrenin
3. [Komut Mühendisliği](02-prompt-engineering/README.md) - Etkili komut tasarımında ustalaşın
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Akıllı bilgi temelli sistemler oluşturun
...
2. **Code** → **Codespaces** sekmesine tıklayın → **...** → **Yeni seçeneklerle...** seçin
3. Varsayılanları kullanın – bu kurs için oluşturulan Geliştirme konteyneri seçilecek
...
Modülleri tamamladıktan sonra LangChain4j test kavramlarını uygulamalı olarak görmek için [Test Rehberine](docs/TESTING.md) göz atın.

> **Not:** Bu eğitim GitHub Modelleri ve Azure OpenAI'yi birlikte kullanır. [Hızlı Başlangıç](00-quick-start/README.md) modülü GitHub Modellerini kullanır (Azure aboneliği gerekmez), modül 1-5 ise Azure OpenAI kullanır. Eğer yoksa [ÜCRETSİZ Azure hesabı](https://aka.ms/azure-free-account) ile başlayabilirsiniz.


## GitHub Copilot ile Öğrenme

Hızlıca kodlamaya başlamak için bu projeyi GitHub Codespace'de veya sağlanan devcontainer ile yerel IDE'nizde açın. Bu kursta kullanılan devcontainer, AI eşli programlama için GitHub Copilot ile önceden yapılandırılmıştır.

Her kod örneği, GitHub Copilot’a sorabileceğiniz önerilen sorular içerir, böylece anlayışınızı derinleştirebilirsiniz. 💡/🤖 ifadelerini şu yerlerde arayın:
...
Daha fazla bilgi edinmek ister misiniz? [AI Eşli Programlama için Copilot](https://aka.ms/GitHubCopilotAI) sayfasına bakın.
...
Takılırsanız veya yapay zeka uygulamaları oluştururken sorularınız olursa, katılın:
