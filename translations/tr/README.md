...
#### GitHub Action (Otomatik ve Her Zaman Güncel) ile Desteklenir
...
>
> Bu depo 50'den fazla dil çevirisini içerir ve bu, indirme boyutunu önemli ölçüde artırır. Çeviriler olmadan kopyalamak için seyrek checkout kullanın:
>
> **Bash / macOS / Linux:**
> ```bash
...
2. [Tanıtım](01-introduction/README.md) - LangChain4j’nin temellerini öğrenin
3. [Prompt Mühendisliği](02-prompt-engineering/README.md) - Etkili prompt tasarımında ustalaşın
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Akıllı bilgi tabanlı sistemler kurun
5. [Araçlar](04-tools/README.md) - Harici araçları ve basit yardımcıları entegre edin
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Model Context Protocol (MCP) ve Agentic modülleri ile çalışın
---

## Öğrenme Yolu

**LangChain4j'de yen misiniz?** Temel terimler ve kavramlar için [Sözlüğe](docs/GLOSSARY.md) göz atın.

> **Hızlı Başlangıç**

1. Bu depoyu GitHub hesabınıza fork’layın
2. **Code** → **Codespaces** sekmesine tıklayın → **...** → **Yeni seçeneklerle...** seçeneğini tıklayın
...
Modülleri tamamladıktan sonra, LangChain4j test konseptlerini uygulamalı görmek için [Test Rehberi](docs/TESTING.md)’ni keşfedin.

> **Not:** Bu eğitim hem GitHub Modellerini hem de Azure OpenAI’yi kullanır. [Hızlı Başlangıç](00-quick-start/README.md) modülü GitHub Modellerini kullanır (Azure aboneliği gerektirmez), modüller 1-5 Azure OpenAI kullanır. Henüz bir hesabınız yoksa [ÜCRETSİZ Azure hesabı](https://aka.ms/azure-free-account) ile başlayın.


## GitHub Copilot ile Öğrenme

Hızlıca kodlamaya başlamak için bu projeyi bir GitHub Codespace içinde ya da sağlanan devcontainer ile yerel IDE’nizde açın. Bu kursta kullanılan devcontainer, AI eşli programlama için önceden yapılandırılmış GitHub Copilot içerir.

Her kod örneği, GitHub Copilot’a sorabileceğiniz ve anlayışınızı derinleştirecek önerilen soruları içerir. 💡/🤖 işaretlerini arayın:

- **Java dosya başlıklarında** - Her örneğe özel sorular
- **Modül README dosyalarında** - Kod örneklerinden sonra keşif önerileri

**Kullanımı:** Herhangi bir kod dosyasını açın ve Copilot’a önerilen soruları sorun. Koda tam erişimi vardır ve açıklayabilir, genişletebilir, alternatifler önerebilir.

Daha fazla öğrenmek ister misiniz? [AI Eşli Programlama için Copilot](https://aka.ms/GitHubCopilotAI)’yı inceleyin.
...
Tıkanırsanız veya AI uygulamaları geliştirme hakkında sorularınız varsa, katılın:
