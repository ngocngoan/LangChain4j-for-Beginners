...
Cada módulo tem uma sessão ao vivo acompanhante onde exploramos os conceitos e o código passo a passo.
...
Após completar os módulos, explore o [Guia de Testes](docs/TESTING.md) para ver conceitos de teste no LangChain4j em ação.

> **Nota:** Este treinamento usa tanto GitHub Models quanto Azure OpenAI. O módulo [Início Rápido](00-quick-start/README.md) usa GitHub Models (não requer assinatura Azure), enquanto os módulos 1-5 usam Azure OpenAI. Comece com uma [conta GRATUITA Azure](https://aka.ms/azure-free-account) se ainda não tiver uma.


## Aprendendo com GitHub Copilot

Para começar a programar rápido, abra este projeto em um GitHub Codespace ou em seu IDE local com o devcontainer fornecido. O devcontainer usado neste curso já vem pré-configurado com GitHub Copilot para programação pareada com IA.
...
- **READMEs dos módulos** - Prompts exploratórios após exemplos de código

**Como usar:** Abra qualquer arquivo de código e faça ao Copilot as perguntas sugeridas. Ele tem contexto completo da base de código e pode explicar, estender e sugerir alternativas.

Quer aprender mais? Veja [Copilot para Programação Pareada com IA](https://aka.ms/GitHubCopilotAI).
...
Se você ficar preso ou tiver alguma dúvida sobre criar apps de IA, junte-se a:

[![Discord Microsoft Foundry](https://img.shields.io/badge/Discord-Microsoft_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)
