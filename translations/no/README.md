...
3. [Prompt Engineering](02-prompt-engineering/README.md) - Mestre effektiv utforming av prompts
...
**Ny til LangChain4j?** Se [Glossaret](docs/GLOSSARY.md) for definisjoner av nøkkelbegreper og konsepter.
...
6. Gå direkte til [Rask start](./00-quick-start/README.md) for å komme i gang!

Etter å ha fullført modulene, utforsk [Testveiledningen](docs/TESTING.md) for å se LangChain4j testkonsepter i praksis.

> **Merk:** Denne treningen bruker både GitHub-modeller og Azure OpenAI. [Rask start](00-quick-start/README.md)-modulen bruker GitHub-modeller (ingen Azure-abonnement nødvendig), mens modul 1-5 bruker Azure OpenAI. Kom i gang med en [GRATIS Azure-konto](https://aka.ms/azure-free-account) hvis du ikke har en.


## Læring med GitHub Copilot

For å komme raskt i gang med koding åpner du dette prosjektet i en GitHub Codespace eller din lokale IDE med den medfølgende devcontaineren. Devcontaineren som brukes i dette kurset kommer forhåndskonfigurert med GitHub Copilot for AI-parprogrammering.

Hver kodeeksempel inkluderer foreslåtte spørsmål du kan stille GitHub Copilot for å utdype din forståelse. Se etter 💡/🤖-promptene i:

- **Java filoverskrifter** - Spørsmål spesifikke for hvert eksempel
- **Modul-README-er** - Utforskningsprompt etter kodeeksempler
...
Hvis du har produkttilbakemeldinger eller feil under bygging, besøk:
