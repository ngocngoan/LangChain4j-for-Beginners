...
> ```
> Ini memberikan anda segala yang anda perlukan untuk menamatkan kursus dengan muat turun lebih pantas.
...
1. [Permulaan Pantas](00-quick-start/README.md) - Mulakan dengan LangChain4j  
2. [Pengenalan](01-introduction/README.md) - Pelajari asas-asas LangChain4j  
3. [Reka Bentuk Arahan](02-prompt-engineering/README.md) - Kuasai reka bentuk arahan berkesan  
4. [RAG (Generasi Diperkaya Dengan Pencarian)](03-rag/README.md) - Bina sistem berpengetahuan pintar  
5. [Alat](04-tools/README.md) - Integrasi alat luar dan pembantu mudah  
6. [MCP (Protokol Konteks Model)](05-mcp/README.md) - Bekerja dengan Protokol Konteks Model (MCP) dan modul Agen  
...
5. Tunggu 5-10 minit untuk persekitaran siap  
6. Terus lompat ke [Permulaan Pantas](./00-quick-start/README.md) untuk bermula!

Selepas melengkapkan modul, terokai [Panduan Ujian](docs/TESTING.md) untuk melihat konsep ujian LangChain4j dalam tindakan.

> **Nota:** Latihan ini menggunakan Model GitHub dan Azure OpenAI. Modul [Permulaan Pantas](00-quick-start/README.md) menggunakan Model GitHub (tidak memerlukan langganan Azure), manakala modul 1-5 menggunakan Azure OpenAI. Mulakan dengan [akaun Azure PERCUMA](https://aka.ms/azure-free-account) jika anda belum ada.


## Pembelajaran dengan GitHub Copilot

Untuk mula menulis kod dengan pantas, buka projek ini di GitHub Codespace atau IDE tempatan anda dengan devcontainer yang disediakan. Devcontainer yang digunakan dalam kursus ini telah dikonfigurasi terlebih dahulu dengan GitHub Copilot untuk pengaturcaraan berpasangan AI.

Setiap contoh kod termasuk soalan yang disyorkan yang boleh anda tanya kepada GitHub Copilot untuk memperdalam pemahaman anda. Cari petunjuk 💡/🤖 dalam:

- **Header fail Java** - Soalan khusus untuk setiap contoh  
- **README modul** - Petunjuk penerokaan selepas contoh kod

**Cara menggunakan:** Buka mana-mana fail kod dan tanya Copilot soalan yang disyorkan. Ia mempunyai konteks penuh kod dan boleh menerangkan, meluaskan, dan mencadangkan alternatif.
...
**Penafian**:  
Dokumen ini telah diterjemahkan menggunakan perkhidmatan terjemahan AI [Co-op Translator](https://github.com/Azure/co-op-translator). Walaupun kami berusaha untuk ketepatan, sila ambil perhatian bahawa terjemahan automatik mungkin mengandungi kesilapan atau ketidaktepatan. Dokumen asal dalam bahasa asalnya hendaklah dianggap sebagai sumber yang sahih. Untuk maklumat penting, penerjemahan profesional oleh manusia adalah disyorkan. Kami tidak bertanggungjawab atas sebarang salah faham atau salah tafsir yang timbul daripada penggunaan terjemahan ini.
