...
Een cursus voor het bouwen van AI-toepassingen met LangChain4j en Azure OpenAI GPT-5.2, van eenvoudige chat tot AI-agenten.

**Nieuw met LangChain4j?** Bekijk de [Glossary](docs/GLOSSARY.md) voor definities van sleutelbegrippen en concepten.

## Inhoudsopgave

1. [Snelle Start](00-quick-start/README.md) - Begin met LangChain4j
...
5. [Hulpmiddelen](04-tools/README.md) - Integreer externe hulpmiddelen en eenvoudige assistenten
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Werk met het Model Context Protocol (MCP) en Agent-modules
---
...
> **Opmerking:** Deze training maakt gebruik van zowel GitHub Models als Azure OpenAI. De module [Snelle Start](00-quick-start/README.md) gebruikt GitHub Models (geen Azure-abonnement nodig), terwijl modules 1-5 Azure OpenAI gebruiken. Begin met een [GRATIS Azure-account](https://aka.ms/azure-free-account) als je er nog geen hebt.


## Leren met GitHub Copilot

Om snel te starten met coderen, open dit project in een GitHub Codespace of je lokale IDE met de voorziene devcontainer. De devcontainer die in deze cursus wordt gebruikt, is vooraf geconfigureerd met GitHub Copilot voor AI-gestuurde pair programming.

Elk codevoorbeeld bevat voorgestelde vragen die je GitHub Copilot kunt stellen om je begrip te verdiepen. Let op de 💡/🤖 prompts in:

- **Java-bestandheaders** - Vragen specifiek voor elk voorbeeld
- **Module README's** - Verkenningsvragen na codevoorbeelden

**Hoe te gebruiken:** Open een willekeurig codebestand en stel Copilot de voorgestelde vragen. Hij heeft volledige context van de codebase en kan uitleggen, uitbreiden en alternatieven suggereren.
