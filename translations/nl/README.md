<img src="../../translated_images/nl/LangChain4j.90e1d693fcc71b50.webp" alt="LangChain4j" width="800"/>

# LangChain4j voor Beginners

Een cursus voor het bouwen van AI-toepassingen met LangChain4j en Azure OpenAI GPT-5.2, van basischat tot AI-agenten.
...
1. [Snelle Start](00-quick-start/README.md) - Aan de slag met LangChain4j
...
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Werk met het Model Context Protocol (MCP) en Agentische modules

### Video Uitleg

Elke module heeft een live sessie waarin we de concepten en code stap voor stap doornemen.

| Module | Video |
|--------|-------|
| 01 - Introductie | [Aan de slag met LangChain4j](https://www.youtube.com/live/nl_troDm8rQ) |
| 02 - Prompt Engineering | [Prompt Engineering met LangChain4j](https://www.youtube.com/live/PJ6aBaE6bog) |
| 03 - RAG | [RAG met LangChain4j](https://www.youtube.com/watch?v=_olq75ZH_eY) |
| 04 - Tools & 05 - MCP | [AI Agenten met Tools en MCP](https://www.youtube.com/watch?v=O_J30kZc0rw) |
...
2. Klik op **Code** → tab **Codespaces** → **...** → **New with options...**
...
6. Ga direct naar [Snelle Start](./00-quick-start/README.md) om te beginnen!

Na het afronden van de modules, verken de [Testing Guide](docs/TESTING.md) om de LangChain4j testconcepten in actie te zien.

> **Opmerking:** Deze training maakt gebruik van zowel GitHub Models als Azure OpenAI. De module [Snelle Start](00-quick-start/README.md) gebruikt GitHub Models (geen Azure-abonnement vereist), terwijl modules 1-5 Azure OpenAI gebruiken. Begin met een [GRATIS Azure-account](https://aka.ms/azure-free-account) als je er nog geen hebt.


## Leren met GitHub Copilot

Om snel te beginnen met coderen, open je dit project in een GitHub Codespace of in je lokale IDE met de meegeleverde devcontainer. De devcontainer die in deze cursus wordt gebruikt, is vooraf geconfigureerd met GitHub Copilot voor AI-paired programming.

Elk codevoorbeeld bevat voorgestelde vragen die je aan GitHub Copilot kunt stellen om je begrip te verdiepen. Zoek naar de 💡/🤖 prompts in:

- **Java-bestandskoppen** - Vragen specifiek voor elk voorbeeld
- **Module READMEs** - Verkenningsopdrachten na codevoorbeelden

**Hoe te gebruiken:** Open elk codebestand en stel Copilot de voorgestelde vragen. Hij heeft volledige context van de codebasis en kan uitleggen, uitbreiden en alternatieven voorstellen.

Wil je meer leren? Bekijk [Copilot voor AI Paired Programming](https://aka.ms/GitHubCopilotAI).
...
Als je vastloopt of vragen hebt over het bouwen van AI-apps, doe mee met:
