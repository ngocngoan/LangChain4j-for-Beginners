...
> Deze repository bevat vertalingen in meer dan 50 talen, wat de downloadgrootte aanzienlijk verhoogt. Om zonder vertalingen te klonen, gebruik sparse checkout:
> ```bash
...
Een cursus voor het bouwen van AI-toepassingen met LangChain4j en Azure OpenAI GPT-5, van basale chat tot AI-agenten.

**Nieuw bij LangChain4j?** Bekijk de [Glossary](docs/GLOSSARY.md) voor definities van belangrijke termen en concepten.

## Inhoudsopgave

1. [Snel Beginnen](00-quick-start/README.md) - Aan de slag met LangChain4j
2. [Introductie](01-introduction/README.md) - Leer de basisprincipes van LangChain4j
3. [Prompt Engineering](02-prompt-engineering/README.md) - Beheers effectieve prompt-ontwerp
...
6. Ga direct naar [Snel Beginnen](./00-quick-start/README.md) om te starten!

Na het afronden van de modules, verken de [Testhandleiding](docs/TESTING.md) om LangChain4j testconcepten in actie te zien.

> **Opmerking:** Deze training gebruikt zowel GitHub Models als Azure OpenAI. De module [Snel Beginnen](00-quick-start/README.md) gebruikt GitHub Models (geen Azure-abonnement nodig), terwijl modules 1-5 Azure OpenAI gebruiken. Begin met een [GRATIS Azure-account](https://aka.ms/azure-free-account) als je er nog geen hebt.


## Leren met GitHub Copilot

Om snel te beginnen met coderen, open dit project in een GitHub Codespace of je lokale IDE met de meegeleverde devcontainer. De devcontainer die in deze cursus wordt gebruikt, is vooraf geconfigureerd met GitHub Copilot voor AI paired programming.

Elk codevoorbeeld bevat voorgestelde vragen die je GitHub Copilot kunt stellen om je begrip te verdiepen. Zoek naar de 💡/🤖 prompts in:

- **Java-bestand headers** - Vragen specifiek voor elk voorbeeld
- **Module READMEs** - Verkenningsaanwijzingen na codevoorbeelden

**Hoe te gebruiken:** Open een willekeurig codebestand en stel de voorgestelde vragen aan Copilot. Hij heeft volledige context van de codebase en kan uitleggen, uitbreiden en alternatieven voorstellen.
