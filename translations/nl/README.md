...
Een cursus voor het bouwen van AI-toepassingen met LangChain4j en Azure OpenAI GPT-5.2, van basisgesprekken tot AI-agenten.

**Nieuw met LangChain4j?** Bekijk de [Glossary](docs/GLOSSARY.md) voor definities van kernbegrippen en concepten.
...
5. Wacht 5-10 minuten totdat de omgeving klaar is
6. Ga direct naar [Quick Start](./00-quick-start/README.md) om te beginnen!

Na het voltooien van de modules, verken de [Testing Guide](docs/TESTING.md) om de testconcepten van LangChain4j in actie te zien.

> **Opmerking:** Deze training gebruikt zowel GitHub Models als Azure OpenAI. De module [Quick Start](00-quick-start/README.md) gebruikt GitHub Models (geen Azure-abonnement vereist), terwijl modules 1-5 Azure OpenAI gebruiken. Begin met een [GRATIS Azure-account](https://aka.ms/azure-free-account) als je er nog geen hebt.


## Leren met GitHub Copilot

Om snel te starten met coderen, open je dit project in een GitHub Codespace of je lokale IDE met de meegeleverde devcontainer. De devcontainer die in deze cursus wordt gebruikt, is vooraf geconfigureerd met GitHub Copilot voor AI-gepaard programmeren.
...
- **Java-bestandheaders** - Vragen specifiek voor elk voorbeeld
- **Module READMEs** - Verkenningsprompts na codevoorbeelden

**Hoe te gebruiken:** Open elk codebestand en stel Copilot de voorgestelde vragen. Het heeft volledige context van de codebase en kan uitleggen, uitbreiden en alternatieven voorstellen.

Wil je meer leren? Bekijk [Copilot for AI Paired Programming](https://aka.ms/GitHubCopilotAI).
