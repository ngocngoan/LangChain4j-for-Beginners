...
Un cours pour construire des applications IA avec LangChain4j et Azure OpenAI GPT-5.2, du chat basique aux agents IA.

**Nouveau dans LangChain4j ?** Consultez le [Glossaire](docs/GLOSSARY.md) pour les définitions des termes et concepts clés.
...
3. [Conception de prompts](02-prompt-engineering/README.md) - Maîtrisez la conception efficace de prompts
...
6. [MCP (Protocole de contexte modèle)](05-mcp/README.md) - Travaillez avec le protocole MCP et les modules Agentiques
---
...
3. Gardez les paramètres par défaut – cela sélectionnera le conteneur de développement créé pour ce cours
4. Cliquez sur **Créer espace de code**
5. Attendez 5-10 minutes que l’environnement soit prêt
6. Passez directement à [Démarrage rapide](./00-quick-start/README.md) pour commencer !

Après avoir complété les modules, explorez le [Guide de test](docs/TESTING.md) pour voir en pratique les concepts de test LangChain4j.

> **Note :** Cette formation utilise à la fois les modèles GitHub et Azure OpenAI. Le module [Démarrage rapide](00-quick-start/README.md) utilise les modèles GitHub (pas d’abonnement Azure requis), tandis que les modules 1 à 5 utilisent Azure OpenAI. Commencez avec un [compte Azure GRATUIT](https://aka.ms/azure-free-account) si vous n’en avez pas.


## Apprentissage avec GitHub Copilot

Pour commencer rapidement à coder, ouvrez ce projet dans un Codespace GitHub ou votre IDE local avec le conteneur devcontainer fourni. Le devcontainer utilisé dans ce cours est préconfiguré avec GitHub Copilot pour la programmation assistée par IA.
...
**Comment utiliser :** Ouvrez n’importe quel fichier de code et posez à Copilot les questions suggérées. Il a le contexte complet de la base de code et peut expliquer, étendre, et suggérer des alternatives.
