...
Курс за изграждане на AI приложения с LangChain4j и Azure OpenAI GPT-5.2, от основни чатове до AI агенти.
...
3. [Проектиране на подканващи изявления](02-prompt-engineering/README.md) - Овладейте ефективния дизайн на подканващи изявления
4. [RAG (Генерация с допълнително извличане)](03-rag/README.md) - Изградете интелигентни системи, базирани на знания
5. [Инструменти](04-tools/README.md) - Интегрирайте външни инструменти и прости асистенти
6. [MCP (Протокол на контекста на модела)](05-mcp/README.md) - Работа с Протокола на контекста на модела (MCP) и агентски модули
---
...
5. Изчакайте 5-10 минути за зареждане на средата
6. Пристъпете направо към [Бърз старт](./00-quick-start/README.md) за да започнете!

След като завършите модулите, разгледайте [Ръководството за тестване](docs/TESTING.md), за да видите концепциите на LangChain4j за тестване в действие.

> **Забележка:** Това обучение използва както GitHub модели, така и Azure OpenAI. Модулът [Бърз старт](00-quick-start/README.md) използва GitHub модели (не е необходим абонамент за Azure), докато модулите 1-5 използват Azure OpenAI. Започнете с [БЕЗПЛАТЕН Azure акаунт](https://aka.ms/azure-free-account), ако нямате такъв.


## Обучение с GitHub Copilot

За бърз старт на кодирането, отворете този проект в GitHub Codespace или в локалната си IDE със предоставения devcontainer. Използваният във курса devcontainer е предварително конфигуриран с GitHub Copilot за AI програмиране в сътрудничество.

Всеки примерен код включва предложени въпроси, които можете да зададете на GitHub Copilot за по-дълбоко разбиране. Потърсете подканващите символи 💡/🤖 в:

- **Заглавки на Java файловете** - Специфични въпроси за всеки пример
- **README файловете на модулите** - Въпроси за допълнително изследване след примерите за код

**Как да използвате:** Отворете който и да е код файл и задайте на Copilot предложените въпроси. Той има пълен контекст на кода и може да обяснява, разширява и предлага алтернативи.

Искате да научите повече? Вижте [Copilot за AI програмиране в сътрудничество](https://aka.ms/GitHubCopilotAI).
...
MIT Лиценз - Вижте [LICENSE](../../LICENSE) файла за подробности.
