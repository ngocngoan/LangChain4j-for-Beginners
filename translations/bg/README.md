...
Курс за създаване на AI приложения с LangChain4j и Azure OpenAI GPT-5, от основен чат до AI агенти.

**Нов в LangChain4j?** Разгледайте [Речника](docs/GLOSSARY.md) за определения на ключови термини и концепции.
...
3. [Дизайн на подсказки](02-prompt-engineering/README.md) - Умения за ефективно създаване на подсказки
4. [RAG (Генерация с подсилване чрез извличане)](03-rag/README.md) - Изградете интелигентни системи с бази знания
5. [Инструменти](04-tools/README.md) - Интегрирайте външни инструменти и прости асистенти
6. [MCP (Протокол за контекст на модел)](05-mcp/README.md) - Работа с MCP и агентни модули
---
...
5. Изчакайте 5-10 минути, за да бъде средата готова
6. Отправете се директно към [Бърз старт](./00-quick-start/README.md), за да започнете!

След завършването на модулите проучете [Ръководството за тестове](docs/TESTING.md), за да видите концепциите за тестване в LangChain4j на практика.

> **Забележка:** Това обучение използва както GitHub модели, така и Azure OpenAI. Модулът [Бърз старт](00-quick-start/README.md) използва GitHub модели (не се изисква абонамент за Azure), докато модулите 1-5 използват Azure OpenAI. Започнете с [БЕЗПЛАТЕН Azure акаунт](https://aka.ms/azure-free-account), ако нямате такъв.


## Обучение с GitHub Copilot

За бързо започване с програмиране отворете проекта в GitHub Codespace или локалното си IDE с предоставения devcontainer. Devcontainer-ът, използван в този курс, е предварително конфигуриран с GitHub Copilot за AI съвместно програмиране.

Във всеки примерен код са включени предложения за въпроси, които можете да зададете на GitHub Copilot, за да задълбочите разбирането си. Потърсете знаците 💡/🤖 в:

- **Java заглавия на файлове** - Въпроси, специфични за всеки пример
- **README файлове на модулите** - Изследователски подсказки след примерните кодове

**Как да използвате:** Отворете който и да е кодов файл и задайте предложените въпроси на Copilot. Той има пълен контекст на кода и може да обяснява, разширява и предлага алтернативи.

Искате ли да научите повече? Разгледайте [Copilot за AI съвместно програмиране](https://aka.ms/GitHubCopilotAI).
...
[![Данни за науката за начинаещи](https://img.shields.io/badge/Data%20Science%20for%20Beginners-84CC16?style=for-the-badge&labelColor=E5E7EB&color=84CC16)](https://aka.ms/datascience-beginners?WT.mc_id=academic-105485-koreyst)
...
Ако сте се закачили или имате въпроси относно създаването на AI приложения, присъединете се към:
