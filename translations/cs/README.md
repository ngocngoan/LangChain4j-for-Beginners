...
Kurz pro vytváření AI aplikací s LangChain4j a Azure OpenAI GPT-5.2, od základního chatu po AI agenty.
...
Po dokončení modulů prozkoumejte [Návod na testování](docs/TESTING.md), kde uvidíte koncepty testování LangChain4j v praxi.

> **Poznámka:** Tento kurz využívá jak GitHub Models, tak Azure OpenAI. Modul [Rychlý start](00-quick-start/README.md) používá GitHub Models (není potřeba Azure předplatné), zatímco moduly 1-5 používají Azure OpenAI. Začněte s [ZDARMA Azure účtem](https://aka.ms/azure-free-account), pokud jej ještě nemáte.

## Učení s GitHub Copilot

Pro rychlý start s kódováním otevřete tento projekt v GitHub Codespace nebo ve svém lokálním IDE s poskytnutým devcontainerem. Devcontainer používaný v tomto kurzu je přednastavený s GitHub Copilot pro AI párové programování.

Každý příklad kódu obsahuje navrhované otázky, které můžete GitHub Copilotu položit pro hlubší porozumění. Hledejte výzvy 💡/🤖 v:

- **hlavičkách Java souborů** - otázky specifické pro každý příklad
- **README modulů** - výzvy k prozkoumání po příkladech kódu

**Jak používat:** Otevřete libovolný kódový soubor a zeptejte se Copilota na navrhované otázky. Má plný kontext kódu a může vysvětlit, rozšířit a navrhnout alternativy.
...
Pokud se zaseknete nebo máte jakékoli otázky ohledně vytváření AI aplikací, přidejte se:
...
Tento dokument byl přeložen pomocí AI překladatelské služby [Co-op Translator](https://github.com/Azure/co-op-translator). Přestože se snažíme o přesnost, mějte prosím na paměti, že automatizované překlady mohou obsahovat chyby nebo nepřesnosti. Originální dokument v jeho rodném jazyce by měl být považován za autoritativní zdroj. Pro kritické informace se doporučuje profesionální lidský překlad. Nejsme odpovědní za žádné nedorozumění nebo nesprávné výklady vyplývající z použití tohoto překladu.
