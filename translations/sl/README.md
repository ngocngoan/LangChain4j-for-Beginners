...
**Novo v LangChain4j?** Oglejte si [Slovar](docs/GLOSSARY.md) za definicije ključnih izrazov in pojmov.
...
4. [RAG (Generacija z iskanjem)](03-rag/README.md) - Ustvarjanje inteligentnih sistemov za znanje
5. [Orodja](04-tools/README.md) - Integrirajte zunanja orodja in preproste asistente
6. [MCP (Protokol konteksta modela)](05-mcp/README.md) - Delo s protokolom MCP in agentnimi moduli
---
...
2. Kliknite **Code** → zavihek **Codespaces** → **...** → **Novi z možnostmi...**
...
Po zaključku modulov si oglejte [Priročnik za testiranje](docs/TESTING.md), da vidite koncepte testiranja LangChain4j v praksi.

> **Opomba:** Ta izobraževanje uporablja tako GitHub Models kot Azure OpenAI. Modul [Hitri začetek](00-quick-start/README.md) uporablja GitHub Models (ni potrebna naročnina Azure), medtem ko moduli 1-5 uporabljajo Azure OpenAI. Začnite z [BREZPLAČNIM računom Azure](https://aka.ms/azure-free-account), če ga še nimate.


## Učenje z GitHub Copilotom

Če želite hitro začeti s kodiranjem, odprite ta projekt v GitHub Codespace ali v svojem lokalnem IDE z zagotovljenim devcontainerjem. Devcontainer, uporabljen v tem tečaju, je prednastavljen z GitHub Copilot za AI skupaj s programskim parjenjem.

Vsak primer kode vključuje predlagana vprašanja, ki jih lahko zastavite GitHub Copilotu za poglobitev vašega razumevanja. Poiščite oznake 💡/🤖 v:

- **Glavah Java datotek** - Vprašanja, specifična za vsak primer
- **Modulskih README-jih** - Izvedbeni pozivi po primerih kode

**Kako uporabljati:** Odprite katero koli datoteko s kodo in zastavite Copilotu predlagana vprašanja. Ima popoln kontekst kode in zna pojasniti, razširiti ter predlagati alternative.

Želite izvedeti več? Oglejte si [Copilot za AI programsko parjenje](https://aka.ms/GitHubCopilotAI).
...
Če imate povratne informacije o produktu ali napake med izdelavo, obiščite:
...
Ta dokument je bil preveden z uporabo AI prevajalske storitve [Co-op Translator](https://github.com/Azure/co-op-translator). Čeprav si prizadevamo za natančnost, vas prosimo, da upoštevate, da avtomatski prevodi lahko vsebujejo napake ali netočnosti. Izvirni dokument v njegovem izvirnem jeziku velja za avtoritativni vir. Za kritične informacije priporočamo strokovni prevod, opravljen s strani človeka. Nismo odgovorni za morebitna nesporazume ali napačne interpretacije, ki izhajajo iz uporabe tega prevoda.
