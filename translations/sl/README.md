...
> ```
>
> To vam omogoča vse, kar potrebujete za dokončanje tečaja s precej hitrejšim prenosom.
...
3. [Oblikovanje pozivov (promptov)](02-prompt-engineering/README.md) - Obvladajte učinkovito oblikovanje pozivov
4. [RAG (generiranje z nadgradnjo na iskanje)](03-rag/README.md) - Zgradite inteligentne sisteme na osnovi znanja
5. [Orodja](04-tools/README.md) - Integrirajte zunanja orodja in enostavne asistente
6. [MCP (Protokol konteksta modela)](05-mcp/README.md) - Delajte s protokolom Model Context Protocol (MCP) in agentnimi moduli
---

## Učna pot

**Nov v LangChain4j?** Preverite [Slovar](docs/GLOSSARY.md) za definicije ključnih izrazov in konceptov.
...
6. Neposredno se premaknite na [Hitri začetek](./00-quick-start/README.md) in začnite!

Po končanih modulih raziščite [Vodnik za testiranje](docs/TESTING.md) in si oglejte koncepte testiranja LangChain4j v praksi.

> **Opomba:** Ta usposabljanje uporablja tako GitHub modele kot Azure OpenAI. Modul [Hitri začetek](00-quick-start/README.md) uporablja GitHub modele (ni potrebno naročnino na Azure), medtem ko moduli 1-5 uporabljajo Azure OpenAI. Začnite z [BREZPLAČNIM Azure računom](https://aka.ms/azure-free-account), če ga še nimate.


## Učenje z GitHub Copilot

Za hitro kodiranje odprite ta projekt v GitHub Codespace ali v svojem lokalnem IDE-ju z zagotovljenim devcontainerjem. Devcontainer, uporabljen v tem tečaju, je predkonfiguriran z GitHub Copilot za AI podporano parno programiranje.
...
- **Java glave datotek** - vprašanja specifična za posamezen primer
- **Modul README-ji** - raziskovalna vprašanja po primerih kode

**Kako uporabljati:** Odprite katerokoli datoteko s kodo in zastavite Copilotu predlagana vprašanja. Ima popoln kontekst kode in lahko pojasni, razširi in predlaga alternative.

Želite izvedeti več? Preverite [Copilot za AI parno programiranje](https://aka.ms/GitHubCopilotAI).
...
### Serija Copilot
[![Copilot za AI programsko dvigovanje](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Ta dokument je bil preveden z uporabo storitve za prevajanje z umetno inteligenco [Co-op Translator](https://github.com/Azure/co-op-translator). Čeprav si prizadevamo za natančnost, vas prosimo, upoštevajte, da lahko avtomatizirani prevodi vsebujejo napake ali netočnosti. Izvirni dokument v izvirnem jeziku velja za avtoritativni vir. Za pomembne informacije priporočamo strokovni prevod, opravljen s strani človeka. Za morebitne nesporazume ali napačne interpretacije, ki izhajajo iz uporabe tega prevoda, ne prevzemamo odgovornosti.
