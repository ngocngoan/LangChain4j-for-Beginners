...
> **Nota:** Este treino usa tanto GitHub Models como Azure OpenAI. O módulo [Início Rápido](00-quick-start/README.md) usa GitHub Models (não requer subscrição Azure), enquanto os módulos 1-5 utilizam Azure OpenAI. Comece com uma [conta Azure GRATUITA](https://aka.ms/azure-free-account) se ainda não tiver.
...
Quer saber mais? Veja [Copilot para Programação em Par com IA](https://aka.ms/GitHubCopilotAI).
