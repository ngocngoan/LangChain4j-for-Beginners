...
4. [RAG (Generação com Recuperação)](03-rag/README.md) - Construa sistemas inteligentes baseados em conhecimento
5. [Ferramentas](04-tools/README.md) - Integre ferramentas externas e assistentes simples
6. [MCP (Protocolo de Contexto de Modelo)](05-mcp/README.md) - Trabalhe com o Protocolo de Contexto de Modelo (MCP) e módulos Agentic
---
...
3. Use as opções predefinidas – isto selecionará o contentor de Desenvolvimento criado para este curso
...
> **Nota:** Este treino usa tanto os Modelos GitHub como o Azure OpenAI. O módulo [Início Rápido](00-quick-start/README.md) usa os Modelos GitHub (não é necessária subscrição Azure), enquanto os módulos 1-5 usam Azure OpenAI. Comece com uma [conta Azure GRATUITA](https://aka.ms/azure-free-account) se ainda não tiver uma.


## Aprender com o GitHub Copilot

Para começar a programar rapidamente, abra este projeto num GitHub Codespace ou no seu IDE local com o devcontainer fornecido. O devcontainer usado neste curso vem pré-configurado com o GitHub Copilot para programação em par com IA.
...
**Como usar:** Abra qualquer ficheiro de código e faça as perguntas sugeridas ao Copilot. Ele tem contexto completo do código-base e pode explicar, expandir e sugerir alternativas.
