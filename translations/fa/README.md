...
> **ترجیح می‌دهید به‌صورت محلی کپی کنید؟**
>
> این مخزن شامل بیش از ۵۰ ترجمه زبان است که حجم دانلود را به‌طور قابل توجهی افزایش می‌دهد. برای کپی بدون ترجمه‌ها، از sparse checkout استفاده کنید:
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> این به شما همه چیز لازم برای اتمام دوره را با سرعت دانلود بسیار بالاتر می‌دهد.
...
**جدید در LangChain4j هستید؟** واژه‌نامه را در [Glossary](docs/GLOSSARY.md) برای تعریف اصطلاحات کلیدی و مفاهیم بررسی کنید.

> **شروع سریع**

1. این مخزن را به حساب GitHub خود فورک کنید  
2. روی **Code** → برگه **Codespaces** → **...** → **New with options...** کلیک کنید  
3. تنظیمات پیش‌فرض را استفاده کنید – این ظرف توسعه‌ای است که برای این دوره ساخته شده  
...
پس از اتمام ماژول‌ها، راهنمای [آزمایش](docs/TESTING.md) را برای مشاهده مفاهیم آزمایش LangChain4j در عمل بررسی کنید.

> **نکته:** این آموزش هم از GitHub Models و هم Azure OpenAI استفاده می‌کند. ماژول [شروع سریع](00-quick-start/README.md) از GitHub Models استفاده می‌کند (نیاز به اشتراک Azure ندارد)، در حالی که ماژول‌های ۱ تا ۵ از Azure OpenAI بهره می‌برند. اگر حساب Azure ندارید، با یک [حساب رایگان Azure](https://aka.ms/azure-free-account) شروع کنید.


## یادگیری با GitHub Copilot

برای شروع سریع برنامه‌نویسی، این پروژه را در یک GitHub Codespace یا محیط توسعه محلی خود با devcontainer ارائه شده باز کنید. devcontainer استفاده شده در این دوره از پیش با GitHub Copilot برای برنامه‌نویسی جفت هوش مصنوعی پیکربندی شده است.

هر نمونه کد شامل سوالاتی پیشنهادی است که می‌توانید از GitHub Copilot بپرسید تا درک خود را عمیق‌تر کنید. به دنبال علامت‌های 💡/🤖 در:

- **سربرگ فایل‌های جاوا** - سوالات خاص هر مثال  
- **README ماژول‌ها** - سوالات کاوش پس از نمونه کدها  

**چگونه استفاده کنیم:** هر فایل کد را باز کنید و سوالات پیشنهادی را از Copilot بپرسید. او کل کدبیس را می‌داند و می‌تواند توضیح دهد، توسعه دهد و پیشنهاد جایگزین‌ها بدهد.

می‌خواهید بیشتر بدانید؟ به [Copilot برای برنامه‌نویسی جفت هوش مصنوعی](https://aka.ms/GitHubCopilotAI) مراجعه کنید.
...
اگر در ساخت برنامه‌های هوش مصنوعی گیر کردید یا سوالی داشتید، بپیوندید به:
...
**سلب مسئولیت**:  
این سند با استفاده از خدمات ترجمه‌ی هوش مصنوعی [Co-op Translator](https://github.com/Azure/co-op-translator) ترجمه شده است. در حالی که ما در تلاش برای دقت هستیم، لطفاً توجه داشته باشید که ترجمه‌های خودکار ممکن است حاوی خطا یا نادرستی باشند. سند اصلی به زبان بومی خود باید به عنوان منبع معتبر در نظر گرفته شود. برای اطلاعات حیاتی، توصیه می‌شود از ترجمه حرفه‌ای انسانی استفاده شود. ما مسئول هیچ‌گونه سوءتفاهم یا برداشت نادرست ناشی از استفاده از این ترجمه نیستیم.
