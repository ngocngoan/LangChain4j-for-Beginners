...
>
> يتضمن هذا المستودع أكثر من 50 ترجمة للغات تزيد بشكل كبير من حجم التنزيل. للاستنساخ بدون الترجمات، استخدم sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
**جديد على LangChain4j؟** اطلع على [المصطلحات](docs/GLOSSARY.md) لتعريفات المصطلحات والمفاهيم الرئيسية.

## جدول المحتويات

1. [البداية السريعة](00-quick-start/README.md) - ابدأ مع LangChain4j
2. [مقدمة](01-introduction/README.md) - تعلم أساسيات LangChain4j
3. [هندسة المحفزات](02-prompt-engineering/README.md) - أتقن تصميم المحفزات الفعالة
...
2. اضغط **الكود** → علامة تبويب **Codespaces** → **...** → **جديد مع الخيارات...**
3. استخدم الإعدادات الافتراضية – سيختار هذا حاوية التطوير المخصصة لهذه الدورة
4. اضغط **إنشاء مساحة الرموز**
5. انتظر من 5 إلى 10 دقائق حتى يكون البيئة جاهزة
6. انطلق مباشرة إلى [البداية السريعة](./00-quick-start/README.md) للبدء!

بعد إكمال الوحدات، استكشف [دليل الاختبار](docs/TESTING.md) لرؤية مفاهيم اختبار LangChain4j في التطبيق.

> **ملاحظة:** يستخدم هذا التدريب كلًا من نماذج GitHub و Azure OpenAI. تستخدم وحدة [البداية السريعة](00-quick-start/README.md) نماذج GitHub (لا يتطلب اشتراك Azure)، بينما تستخدم الوحدات 1-5 Azure OpenAI. ابدأ بحساب [Azure مجاني](https://aka.ms/azure-free-account) إذا لم يكن لديك واحد.


## التعلم مع GitHub Copilot

لبدء الترميز بسرعة، افتح هذا المشروع في GitHub Codespace أو بيئة تطوير متكاملة محلية باستخدام devcontainer المزود. يأتي devcontainer المستخدم في هذه الدورة مهيأ مسبقًا مع GitHub Copilot لبرمجة زوجية بالذكاء الاصطناعي.

يتضمن كل مثال برمجي أسئلة مقترحة يمكنك طرحها على GitHub Copilot لتعميق فهمك. ابحث عن مؤشرات 💡/🤖 في:

- **رؤوس ملفات Java** - أسئلة محددة لكل مثال
- **ملفات README للوحدات** - مؤشرات استكشافية بعد أمثلة الشيفرة

**كيفية الاستخدام:** افتح أي ملف برمجي واطرح على Copilot الأسئلة المقترحة. لديه سياق كامل لقاعدة الشيفرة ويمكن أن يشرح، ويوسع، ويقترح بدائل.
