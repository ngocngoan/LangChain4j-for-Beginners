...
>
> Цей репозиторій включає понад 50 перекладів мовами, що значно збільшує розмір завантаження. Щоб клонувати без перекладів, використовуйте вибіркове завантаження (sparse checkout):
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> Це дасть вам усе необхідне для проходження курсу з більш швидким завантаженням.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

# LangChain4j для початківців

Курс зі створення AI-додатків за допомогою LangChain4j та Azure OpenAI GPT-5.2, від базового чату до AI агентів.
...
2. [Вступ](01-introduction/README.md) - Освойте основи LangChain4j
3. [Проєктування підказок](02-prompt-engineering/README.md) - Навчіться ефективному дизайну підказок
...
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Працюйте з протоколом контексту моделі (MCP) та агентними модулями
---
...
3. Використайте налаштування за замовчуванням – це вибере контейнер для розробки, створений для цього курсу
4. Натисніть **Create codespace**
5. Зачекайте 5-10 хвилин, доки середовище буде готове
6. Переходьте безпосередньо до [Швидкого старту](./00-quick-start/README.md), щоб розпочати!

Після завершення модулів ознайомтеся з [Посібником з тестування](docs/TESTING.md), щоб побачити концепції тестування LangChain4j в дії.

> **Примітка:** Це навчання використовує як GitHub Models, так і Azure OpenAI. Модуль [Швидкий старт](00-quick-start/README.md) використовує GitHub Models (передплата Azure не потрібна), у той час як модулі 1-5 використовують Azure OpenAI. Почніть з [БЕЗКОШТОВНОГО облікового запису Azure](https://aka.ms/azure-free-account), якщо у вас його ще немає.


## Навчання з GitHub Copilot

Щоб швидко почати програмувати, відкрийте цей проєкт у GitHub Codespace або у вашому локальному IDE з наданим devcontainer. Devcontainer, який використовується в цьому курсі, попередньо налаштований з GitHub Copilot для AI-парного програмування.

Кожен приклад коду містить рекомендовані питання, які можна поставити GitHub Copilot для глибшого розуміння. Шукайте підказки 💡/🤖 у:
...
**Як використовувати:** Відкрийте будь-який файл коду і задавайте Copilot запропоновані питання. Він має повний контекст кодової бази та може пояснювати, розширювати і пропонувати альтернативи.
