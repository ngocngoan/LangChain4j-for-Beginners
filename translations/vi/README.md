...
> ```
>
> Cách này cung cấp cho bạn mọi thứ cần thiết để hoàn thành khóa học với tốc độ tải nhanh hơn nhiều.
...
# LangChain4j cho Người Mới

Một khóa học xây dựng ứng dụng AI với LangChain4j và Azure OpenAI GPT-5.2, từ trò chuyện cơ bản đến tác nhân AI.
...
2. [Giới Thiệu](01-introduction/README.md) - Học các khái niệm cơ bản của LangChain4j
3. [Kỹ Thuật Đặt Lệnh](02-prompt-engineering/README.md) - Thành thạo thiết kế prompt hiệu quả
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Xây dựng hệ thống dựa trên kiến thức thông minh
5. [Công Cụ](04-tools/README.md) - Tích hợp công cụ bên ngoài và trợ lý đơn giản
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Làm việc với Model Context Protocol (MCP) và các module Agentic
---
...
3. Sử dụng mặc định – điều này sẽ chọn container Phát triển đã tạo cho khóa học này
4. Nhấn **Create codespace**
5. Chờ 5-10 phút cho môi trường chuẩn bị sẵn sàng
...
> **Lưu ý:** Khóa đào tạo này sử dụng cả GitHub Models và Azure OpenAI. Module [Bắt Đầu Nhanh](00-quick-start/README.md) sử dụng GitHub Models (không cần đăng ký Azure), trong khi các module 1-5 sử dụng Azure OpenAI. Hãy bắt đầu với [tài khoản Azure MIỄN PHÍ](https://aka.ms/azure-free-account) nếu bạn chưa có.


## Học với GitHub Copilot

Để nhanh chóng bắt đầu lập trình, hãy mở dự án này trong GitHub Codespace hoặc IDE cục bộ của bạn với devcontainer đã cung cấp. Devcontainer sử dụng trong khóa học được cấu hình sẵn có GitHub Copilot cho lập trình AI kết hợp.

Mỗi ví dụ mã kèm theo các câu hỏi gợi ý bạn có thể hỏi GitHub Copilot để làm sâu sắc thêm hiểu biết. Tìm các gợi ý 💡/🤖 tại:

- **Đầu tệp Java** - Các câu hỏi cụ thể cho từng ví dụ
- **README các module** - Gợi ý khám phá sau các ví dụ mã

**Cách sử dụng:** Mở bất kỳ tệp mã nào và hỏi Copilot các câu hỏi được gợi ý. Nó hiểu rõ ngữ cảnh toàn bộ mã nguồn và có thể giải thích, mở rộng, và đề xuất phương án thay thế.

Muốn học thêm? Xem thêm [Copilot cho lập trình AI kết hợp](https://aka.ms/GitHubCopilotAI).
...
[![Tác nhân AI cho Người Mới](https://img.shields.io/badge/AI%20Agents%20for%20Beginners-00C49A?style=for-the-badge&labelColor=E5E7EB&color=00C49A)](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)
...
Nếu bạn có phản hồi sản phẩm hoặc gặp lỗi trong quá trình xây dựng, truy cập:
...
Tài liệu này đã được dịch bằng dịch vụ dịch thuật AI [Co-op Translator](https://github.com/Azure/co-op-translator). Mặc dù chúng tôi cố gắng đảm bảo độ chính xác, xin lưu ý rằng bản dịch tự động có thể chứa lỗi hoặc không chính xác. Tài liệu gốc bằng ngôn ngữ gốc nên được xem là nguồn thông tin chính thức. Đối với những thông tin quan trọng, nên sử dụng dịch thuật chuyên nghiệp do con người thực hiện. Chúng tôi không chịu trách nhiệm về bất kỳ sự hiểu lầm hay giải thích sai nào phát sinh từ việc sử dụng bản dịch này.
