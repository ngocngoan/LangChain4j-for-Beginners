...
3. Verwenden Sie die Standardwerte – damit wird der für diesen Kurs erstellte Entwicklungscontainer ausgewählt
...
Nach Abschluss der Module erkunden Sie den [Testing Guide](docs/TESTING.md), um die Konzepte des LangChain4j-Testens in der Praxis zu sehen.

> **Hinweis:** Dieses Training verwendet sowohl GitHub-Modelle als auch Azure OpenAI. Das Modul [Schnellstart](00-quick-start/README.md) nutzt GitHub-Modelle (kein Azure-Abonnement erforderlich), während die Module 1-5 Azure OpenAI verwenden. Starten Sie mit einem [kostenlosen Azure-Konto](https://aka.ms/azure-free-account), wenn Sie noch keines haben.


## Lernen mit GitHub Copilot

Um schnell mit dem Programmieren zu beginnen, öffnen Sie dieses Projekt in einem GitHub Codespace oder Ihrer lokalen IDE mit dem bereitgestellten devcontainer. Der in diesem Kurs verwendete Devcontainer ist vorkonfiguriert mit GitHub Copilot für KI-paarprogrammierung.
...
- **Java-Dateiköpfen** – Fragen speziell zu jedem Beispiel
...
Wenn Sie Hilfe benötigen oder Fragen zum Erstellen von KI-Anwendungen haben, treten Sie bei:
