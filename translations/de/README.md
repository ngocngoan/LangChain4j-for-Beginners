...
5. [Tools](04-tools/README.md) - Integrieren Sie externe Werkzeuge und einfache Assistenten
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Arbeiten Sie mit dem Model Context Protocol (MCP) und agentischen Modulen
---

## Lernpfad

**Neu bei LangChain4j?** Schauen Sie sich das [Glossar](docs/GLOSSARY.md) für Definitionen wichtiger Begriffe und Konzepte an.
...
5. Warten Sie 5-10 Minuten, bis die Umgebung einsatzbereit ist
6. Gehen Sie direkt zum [Schnellstart](./00-quick-start/README.md), um loszulegen!

Nach Abschluss der Module erkunden Sie den [Testing Guide](docs/TESTING.md), um die Konzepte des Testens mit LangChain4j in Aktion zu sehen.

> **Hinweis:** Diese Schulung verwendet sowohl GitHub-Modelle als auch Azure OpenAI. Das Modul [Schnellstart](00-quick-start/README.md) verwendet GitHub-Modelle (kein Azure-Abonnement erforderlich), während die Module 1-5 Azure OpenAI verwenden. Starten Sie mit einem [KOSTENLOSEN Azure-Konto](https://aka.ms/azure-free-account), falls Sie noch keines haben.


## Lernen mit GitHub Copilot

Um schnell mit dem Programmieren zu beginnen, öffnen Sie dieses Projekt in einem GitHub Codespace oder Ihrer lokalen IDE mit dem bereitgestellten devcontainer. Der in diesem Kurs verwendete devcontainer ist vorkonfiguriert mit GitHub Copilot für KI-unterstütztes Paarprogrammieren.

Jedes Code-Beispiel enthält vorgeschlagene Fragen, die Sie GitHub Copilot stellen können, um Ihr Verständnis zu vertiefen. Achten Sie auf die 💡/🤖 Hinweise in:

- **Java-Dateikopfzeilen** - Spezifische Fragen zu jedem Beispiel
- **Modal-READMEs** - Erkundungsanfragen nach Code-Beispielen

**Wie man es verwendet:** Öffnen Sie eine beliebige Code-Datei und stellen Sie Copilot die vorgeschlagenen Fragen. Er hat den vollständigen Kontext der Codebasis und kann erklären, erweitern und Alternativen vorschlagen.
...
### Copilot-Serie
[![Copilot für KI-Kooperationsprogrammierung](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Wenn Sie Produktfeedback haben oder beim Erstellen Fehler auftreten, besuchen Sie:
