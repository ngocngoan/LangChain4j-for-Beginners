...
> ```
>
> Dies gibt Ihnen alles, was Sie brauchen, um den Kurs abzuschließen, mit einem viel schnelleren Download.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

## Inhaltsverzeichnis

1. [Schnellstart](00-quick-start/README.md) - Einstieg in LangChain4j
2. [Einführung](01-introduction/README.md) - Lernen Sie die Grundlagen von LangChain4j
3. [Prompt Engineering](02-prompt-engineering/README.md) - Meistern Sie effektives Prompt-Design
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Erstellen Sie intelligente wissensbasierte Systeme
5. [Werkzeuge](04-tools/README.md) - Integrieren Sie externe Werkzeuge und einfache Assistenten
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Arbeiten Sie mit dem Model Context Protocol (MCP) und agentenbasierten Modulen
...
**Neu bei LangChain4j?** Schauen Sie sich das [Glossar](docs/GLOSSARY.md) für Definitionen von Schlüsselbegriffen und Konzepten an.

> **Schnellstart**

1. Forken Sie dieses Repository in Ihrem GitHub-Konto
2. Klicken Sie auf **Code** → **Codespaces**-Tab → **...** → **Neu mit Optionen...**
3. Verwenden Sie die Voreinstellungen – dies wählt den für diesen Kurs erstellten Development-Container aus
4. Klicken Sie auf **Codespace erstellen**
5. Warten Sie 5-10 Minuten, bis die Umgebung bereit ist
6. Springen Sie direkt zum [Schnellstart](./00-quick-start/README.md), um loszulegen!

Nach Abschluss der Module erkunden Sie den [Testleitfaden](docs/TESTING.md), um LangChain4j-Testkonzepte in Aktion zu sehen.

> **Hinweis:** Dieses Training verwendet sowohl GitHub-Modelle als auch Azure OpenAI. Das Modul [Schnellstart](00-quick-start/README.md) verwendet GitHub-Modelle (kein Azure-Abonnement erforderlich), während Module 1-5 Azure OpenAI nutzen. Legen Sie ein [KOSTENLOSES Azure-Konto](https://aka.ms/azure-free-account) an, falls Sie noch keines haben.


## Lernen mit GitHub Copilot

Um schnell mit dem Programmieren zu beginnen, öffnen Sie dieses Projekt in einem GitHub Codespace oder Ihrer lokalen IDE mit dem bereitgestellten Devcontainer. Der in diesem Kurs verwendete Devcontainer ist vorab mit GitHub Copilot für KI-unterstützte Paarprogrammierung vorkonfiguriert.
...
- **Java-Datei-Kopfzeilen** – Fragen, die speziell für jedes Beispiel gelten
- **Modul-READMEs** – Erkundungsanregungen nach Codebeispielen

**Wie man es benutzt:** Öffnen Sie eine beliebige Code-Datei und stellen Sie Copilot die vorgeschlagenen Fragen. Es hat den vollständigen Kontext des Codes und kann erklären, erweitern und Alternativen vorschlagen.
...
Wenn du nicht weiterkommst oder Fragen zum Erstellen von KI-Apps hast, tritt bei:
