...
>
> Detta repository innehåller över 50 språkversioner vilket avsevärt ökar nedladdningsstorleken. För att klona utan översättningar, använd sparsamt utcheckning:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Ny på LangChain4j?** Kolla in [Glossariet](docs/GLOSSARY.md) för definitioner av viktiga termer och begrepp.
...
1. Fork:a detta repository till ditt GitHub-konto
...
> **Notera:** Denna utbildning använder både GitHub Models och Azure OpenAI. [Kom igång snabbt](00-quick-start/README.md)-modulen använder GitHub Models (ingen Azure-prenumeration krävs), medan modulerna 1-5 använder Azure OpenAI. Kom igång med ett [ GRATIS Azure-konto](https://aka.ms/azure-free-account) om du inte redan har ett.


## Lärande med GitHub Copilot
...
- **Java-filhuvuden** - Frågor som är specifika för varje exempel
