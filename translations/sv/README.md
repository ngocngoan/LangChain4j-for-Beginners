...
En kurs för att bygga AI-applikationer med LangChain4j och Azure OpenAI GPT-5.2, från grundläggande chatt till AI-aggregat.
...
1. Fork detta arkiv till ditt GitHub-konto
...
Efter att du slutfört modulerna, utforska [Testguiden](docs/TESTING.md) för att se LangChain4j testkoncept i praktiken.

> **Notera:** Denna träning använder både GitHub Models och Azure OpenAI. [Snabbstartsmodulen](00-quick-start/README.md) använder GitHub Models (ingen Azure-prenumeration krävs), medan moduler 1-5 använder Azure OpenAI. Kom igång med ett [GRATIS Azure-konto](https://aka.ms/azure-free-account) om du inte har ett.
...
Varje kodexempel innehåller föreslagna frågor du kan ställa till GitHub Copilot för att fördjupa din förståelse. Leta efter 💡/🤖-promptar i:

- **Java-filhöjder** - Frågor specifika för varje exempel
- **Modulernas README-filer** - Utforskningspromptar efter kodexempel

**Hur man använder:** Öppna någon kodfil och ställ Copilot de föreslagna frågorna. Den har fullständig kontext av kodbasen och kan förklara, utöka och föreslå alternativ.
