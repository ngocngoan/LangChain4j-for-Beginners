...
**Baru dengan LangChain4j?** Lihat [Glosarium](docs/GLOSSARY.md) untuk definisi istilah dan konsep utama.

## Daftar Isi

1. [Mulai Cepat](00-quick-start/README.md) - Memulai dengan LangChain4j  
...
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Bangun sistem berbasis pengetahuan cerdas  
5. [Alat](04-tools/README.md) - Integrasikan alat eksternal dan asisten sederhana  
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Bekerja dengan Model Context Protocol (MCP) dan modul Agen  
---
...
2. Klik **Kode** → tab **Codespaces** → **...** → **Baru dengan opsi...**  
3. Gunakan pengaturan default – ini akan memilih container Pengembangan yang dibuat untuk kursus ini  
4. Klik **Buat codespace**  
5. Tunggu 5-10 menit untuk lingkungan siap digunakan  
6. Langsung pergi ke [Mulai Cepat](./00-quick-start/README.md) untuk memulai!
...
> **Catatan:** Pelatihan ini menggunakan GitHub Models dan Azure OpenAI. Modul [Mulai Cepat](00-quick-start/README.md) menggunakan GitHub Models (tidak memerlukan langganan Azure), sedangkan modul 1-5 menggunakan Azure OpenAI. Mulailah dengan [akun Azure GRATIS](https://aka.ms/azure-free-account) jika Anda belum memilikinya.


## Belajar dengan GitHub Copilot

Untuk memulai pengkodean dengan cepat, buka proyek ini di GitHub Codespace atau IDE lokal Anda dengan devcontainer yang disediakan. Devcontainer yang digunakan dalam kursus ini sudah dikonfigurasi dengan GitHub Copilot untuk pemrograman pasangan AI.

Setiap contoh kode menyertakan pertanyaan yang disarankan yang dapat Anda tanyakan ke GitHub Copilot untuk memperdalam pemahaman Anda. Cari tanda 💡/🤖 di:

- **Header file Java** - Pertanyaan khusus untuk setiap contoh  
- **README Modul** - Prompt eksplorasi setelah contoh kode  

**Cara penggunaan:** Buka file kode apa saja dan tanyakan pertanyaan yang disarankan ke Copilot. Ia memiliki konteks lengkap kode dan dapat menjelaskan, memperluas, dan menyarankan alternatif.

Ingin belajar lebih banyak? Lihat [Copilot untuk Pemrograman Pasangan AI](https://aka.ms/GitHubCopilotAI).
