...
>
> Ovaj repozitorij sadrži prijevode na više od 50 jezika što znatno povećava veličinu preuzimanja. Za kloniranje bez prijevoda, koristite sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
4. [RAG (Generiranje s podrškom povratka)](03-rag/README.md) - Izgradite inteligentne sustave temeljenje na znanju
5. [Alati](04-tools/README.md) - Integrirajte vanjske alate i jednostavne asistente
6. [MCP (Protokol konteksta modela)](05-mcp/README.md) - Radite s Model Context Protocol (MCP) i Agent modulima

### Video vodiči

Svaki modul ima prateću live sesiju u kojoj korak po korak prolazimo kroz koncepte i kod.

| Modul | Video |
|--------|-------|
| 01 - Uvod | [Početak rada s LangChain4j](https://www.youtube.com/live/nl_troDm8rQ) |
| 02 - Prompt inženjering | [Prompt inženjering s LangChain4j](https://www.youtube.com/live/PJ6aBaE6bog) |
...
3. Koristite zadano – ovo će odabrati razvojni kontejner kreiran za ovaj tečaj
4. Kliknite **Create codespace**
5. Pričekajte 5-10 minuta da se okruženje pripremi
6. Odmah prijeđite na [Brzi početak](./00-quick-start/README.md) da započnete!

Nakon završetka modula, istražite [Vodič za testiranje](docs/TESTING.md) za pregled koncepata testiranja LangChain4j u praksi.

> **Napomena:** Ova obuka koristi GitHub modele i Azure OpenAI. Modul [Brzi početak](00-quick-start/README.md) koristi GitHub modele (nije potrebna Azure pretplata), dok moduli 1-5 koriste Azure OpenAI. Ako nemate, započnite s [BESPLATNIM Azure računom](https://aka.ms/azure-free-account).

## Učenje uz GitHub Copilot

Za brzo započinjanje programiranja, otvorite ovaj projekt u GitHub Codespace ili u svom lokalnom IDE-u s ponuđenim devcontainerom. Devcontainer korišten u ovom tečaju dolazi unaprijed konfiguriran s GitHub Copilotom za AI sparno programiranje.

Svaki primjer koda sadrži predložena pitanja koja možete postaviti GitHub Copilotu za dublje razumijevanje. Pratite 💡/🤖 naznake u:

- **Zaglavlja Java datoteka** - Pitanja specifična za svaki primjer
- **README datoteke modula** - Pitanja za istraživanje nakon primjera koda

**Kako koristiti:** Otvorite bilo koju datoteku s kodom i postavite Copilotu predložena pitanja. Ima puni kontekst koda i može objasniti, proširiti i predložiti alternative.

Želite li naučiti više? Pogledajte [Copilot za AI sparno programiranje](https://aka.ms/GitHubCopilotAI).
