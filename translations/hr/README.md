...
> **Bolje vam je klonirati lokalno?**
>
...
3. [Prompt inženjering](02-prompt-engineering/README.md) - Savladajte učinkoviti dizajn promptova
...
2. Kliknite **Code** → **Codespaces** karticu → **...** → **Novi s opcijama...**
...
6. Odmah skočite na [Brzi početak](./00-quick-start/README.md) da krenete!

Nakon završetka modula, istražite [Vodič za testiranje](docs/TESTING.md) da vidite koncepte testiranja LangChain4j u akciji.

> **Napomena:** Ova obuka koristi i GitHub modele i Azure OpenAI. Modul [Brzi početak](00-quick-start/README.md) koristi GitHub modele (nije potrebna Azure pretplata), dok moduli 1-5 koriste Azure OpenAI. Počnite s [BESPLATNIM Azure računom](https://aka.ms/azure-free-account) ako ga nemate.


## Učenje uz GitHub Copilot

Za brzi početak kodiranja, otvorite ovaj projekt u GitHub Codespace ili u svojem lokalnom IDE-u s pruženim devcontainerom. Devcontainer koji se koristi u ovom tečaju dolazi unaprijed konfiguriran s GitHub Copilotom za AI programiranje u paru.
...
- **Modulski README-ovi** - upiti za istraživanje nakon primjera koda
