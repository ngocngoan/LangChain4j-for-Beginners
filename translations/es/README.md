...
>
> Este repositorio incluye traducciones en más de 50 idiomas lo que incrementa significativamente el tamaño de la descarga. Para clonar sin las traducciones, usa la extracción selectiva (sparse checkout):
>
> **Bash / macOS / Linux:**
> ```bash
...
Después de completar los módulos, explora la [Guía de Pruebas](docs/TESTING.md) para ver conceptos de testing de LangChain4j en acción.

> **Nota:** Esta formación utiliza tanto GitHub Models como Azure OpenAI. El módulo [Inicio Rápido](00-quick-start/README.md) usa GitHub Models (no se requiere suscripción a Azure), mientras que los módulos 1-5 usan Azure OpenAI. Empieza con una [cuenta Azure GRATUITA](https://aka.ms/azure-free-account) si no tienes una.


## Aprender con GitHub Copilot

Para empezar a programar rápidamente, abre este proyecto en un GitHub Codespace o en tu IDE local con el contenedor de desarrollo proporcionado. El contenedor de desarrollo usado en este curso viene preconfigurado con GitHub Copilot para programación asistida por IA.
...
- **READMEs de módulo** – Prompts de exploración después de los ejemplos de código
