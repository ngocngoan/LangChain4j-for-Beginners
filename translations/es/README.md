...
>
> Este repositorio incluye más de 50 traducciones que aumentan significativamente el tamaño de la descarga. Para clonar sin las traducciones, utiliza sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
> **Nota:** Esta capacitación usa tanto GitHub Models como Azure OpenAI. El módulo [Inicio Rápido](00-quick-start/README.md) utiliza GitHub Models (no requiere suscripción Azure), mientras que los módulos 1-5 usan Azure OpenAI. Comienza con una [cuenta Azure GRATIS](https://aka.ms/azure-free-account) si no tienes una.


## Aprendiendo con GitHub Copilot

Para comenzar a programar rápidamente, abre este proyecto en un GitHub Codespace o en tu IDE local con el devcontainer proporcionado. El devcontainer utilizado en este curso viene preconfigurado con GitHub Copilot para programación en pareja asistida por IA.

Cada ejemplo de código incluye preguntas sugeridas que puedes hacer a GitHub Copilot para profundizar tu comprensión. Busca los indicios 💡/🤖 en:

- **Encabezados de archivos Java** - Preguntas específicas para cada ejemplo
- **READMEs de los módulos** - Indicadores de exploración tras ejemplos de código

**Cómo usar:** Abre cualquier archivo de código y pregunta a Copilot las preguntas sugeridas. Tiene el contexto completo del código y puede explicar, ampliar y sugerir alternativas.

¿Quieres aprender más? Consulta [Copilot para programación en pareja asistida por IA](https://aka.ms/GitHubCopilotAI).
