...
**Solution**: 
1. Try a different region - See [Changing Azure Regions](../../../../01-introduction/infra) section for how to configure regions
...
For issues:
1. Check the [troubleshooting section](../../../../01-introduction/infra) above
