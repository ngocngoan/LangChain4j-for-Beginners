...
#### Palaikoma naudojant GitHub Action (automatiškai ir visuomet atnaujinama)
...
Kursas, skirtas dirbtinio intelekto taikomųjų programų kūrimui su LangChain4j ir Azure OpenAI GPT-5.2, pradedant paprastu pokalbiu ir baigiant DI agentais.

**Naujas LangChain4j?** Peržiūrėkite [Žodynėlį](docs/GLOSSARY.md), kuriame pateikti pagrindinių terminų ir sąvokų apibrėžimai.

## Turinys

1. [Greitas pradėjimas](00-quick-start/README.md) - Pradėkite naudoti LangChain4j
2. [Įvadas](01-introduction/README.md) - Sužinokite LangChain4j pagrindus
3. [Užklausų inžinerija](02-prompt-engineering/README.md) - Įvaldykite efektyvų užklausų kūrimą
...
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Dirbkite su Model Context Protocol (MCP) ir Agentic moduliais
---
...
1. Atšaka šią saugyklą į savo GitHub paskyrą
2. Spustelėkite **Code** → skirtuką **Codespaces** → **...** → **New with options...**
3. Naudokite numatytuosius nustatymus – tai parinks kursui sukurtą kūrimo konteinerį
4. Spustelėkite **Create codespace**
5. Palaukite 5-10 minučių, kol aplinka bus paruošta
6. Iš karto pradėkite nuo [Greito pradėjimo](./00-quick-start/README.md)!

Baigę modulius, peržiūrėkite [Testavimo gaires](docs/TESTING.md), kad pamatytumėte LangChain4j testavimo sampratas veikiant.

> **Pastaba:** Šiame mokyme naudojami tiek GitHub modeliai, tiek Azure OpenAI. [Greito pradėjimo](00-quick-start/README.md) modulis naudoja GitHub modelius (nereikia Azure prenumeratos), o moduliai 1-5 naudoja Azure OpenAI. Jei neturite, pradėkite nuo [NEMOKAMOS Azure paskyros](https://aka.ms/azure-free-account).


## Mokymasis su GitHub Copilot

Norėdami greitai pradėti rašyti kodą, atidarykite šį projektą GitHub Codespace arba savo vietinėje IDE su pateiktu devcontainer. Šiame kurse naudojamas devcontainer iš anksto sukonfigūruotas su GitHub Copilot DI porinėje programavimo aplinkoje.

Kiekviename kodo pavyzdyje yra siūlomi klausimai, kuriuos galite užduoti GitHub Copilot, kad giliau suprastumėte temą. Ieškokite 💡/🤖 patarimų šiuose vietose:

- **Java failų antraštėse** - klausimai specifiniai kiekvienam pavyzdžiui
- **Modulių README** - tyrinėjimo užuominos po kodo pavyzdžių

**Kaip naudoti:** Atidarykite bet kurį kodo failą ir užduokite Copilot siūlomus klausimus. Jis turi pilną kontekstą apie kodų bazę ir gali paaiškinti, išplėsti ar pasiūlyti alternatyvas.
...
[![Web programavimas pradedantiesiems](https://img.shields.io/badge/Web%20Dev%20for%20Beginners-EC4899?style=for-the-badge&labelColor=E5E7EB&color=EC4899)](https://aka.ms/webdev-beginners?WT.mc_id=academic-105485-koreyst)
...
Jei pasiklydote ar turite klausimų apie AI programų kūrimą, prisijunkite prie:

[![Azure AI Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

Jei turite produkto atsiliepimų ar aptikote klaidų kūrimo metu, apsilankykite:

[![Azure AI Foundry Developer Forum](https://img.shields.io/badge/GitHub-Azure_AI_Foundry_Developer_Forum-blue?style=for-the-badge&logo=github&color=000000&logoColor=fff)](https://aka.ms/foundry/forum)

## Licencija

MIT licencija - Daugiau informacijos skaitykite faile [LICENSE](../../LICENSE).

---

<!-- CO-OP TRANSLATOR DISCLAIMER START -->
**Atsakomybės apribojimas**:
Šis dokumentas buvo išverstas naudojant dirbtinio intelekto vertimo paslaugą [Co-op Translator](https://github.com/Azure/co-op-translator). Nors stengiamės užtikrinti tikslumą, prašome atkreipti dėmesį, kad automatizuoti vertimai gali turėti klaidų ar netikslumų. Originalus dokumentas jo gimtąja kalba laikomas pagrindiniu ir autoritetingu šaltiniu. Svarbiai informacijai rekomenduojama pasitelkti profesionalų žmogaus vertimą. Mes neatsakome už bet kokius nesusipratimus ar klaidingus aiškinimus, kylantys dėl šio vertimo naudojimo.
