...
Kursas kuriant AI programas su LangChain4j ir Azure OpenAI GPT-5.2, nuo paprasto pokalbio iki AI agentų.
...
>
> Šis saugykla apima daugiau nei 50 kalbų vertimų, todėl žymiai padidina atsisiuntimo dydį. Norėdami klonuoti be vertimų, naudokite sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> Tai suteikia viską, ko reikia kursui, ir atsisiunčia daug greičiau.
...
3. [Užklausų kūrimas](02-prompt-engineering/README.md) - Įvaldę efektyvų užklausų kūrimą
4. [RAG (Paieškos papildymo generavimas)](03-rag/README.md) - Kurkite protingas žinių sistemas
5. [Įrankiai](04-tools/README.md) - Integruokite išorinius įrankius ir paprastus padėjėjus
6. [MCP (Modelio konteksto protokolas)](05-mcp/README.md) - Dirbkite su Modelio konteksto protokolu (MCP) ir agentinėmis moduliais

### Vaizdo įrašų gidai

Kiekvienas modulis turi tiesioginę sesiją, kurioje žingsnis po žingsnio aptariame koncepcijas ir kodą.
...
**Naujas LangChain4j?** Peržiūrėkite [Žodynėlį](docs/GLOSSARY.md), kad sužinotumėte svarbiausias sąvokas ir terminus.

> **Greita pradžia**

1. Padarykite šios saugyklos forkʼą į savo GitHub paskyrą
2. Spauskite **Code** → skirtuką **Codespaces** → **...** → **New with options...**
...
6. Tiesiogiai eikite į [Greitą pradžią](./00-quick-start/README.md) ir pradėkite!

Baigę modulius, išbandykite [Testavimo vadovą](docs/TESTING.md), kad pamatytumėte LangChain4j testavimo koncepcijas veikime.

> **Pastaba:** Šis mokymas naudoja tiek GitHub modelius, tiek Azure OpenAI. [Greito pradžios](00-quick-start/README.md) modulis naudoja GitHub modelius (nereikia Azure prenumeratos), o moduliai 1-5 naudoja Azure OpenAI. Jei neturite, pradėkite su [nemokama Azure paskyra](https://aka.ms/azure-free-account).


## Mokymasis su GitHub Copilot

Norėdami greitai pradėti programavimą, atidarykite šį projektą GitHub Codespace arba savo vietinėje IDE su pateiktu devcontainer. Šiame kurse naudojamas devcontainer yra iš anksto sukonfigūruotas su GitHub Copilot AI porinio programavimo palaikymu.

Kiekviename kodo pavyzdyje yra siūlomų klausimų, kuriuos galite užduoti GitHub Copilot norėdami gilinti savo supratimą. Ieškokite 💡/🤖 paskatų:

- **Java failų antraštėse** – klausimai, specifiniai kiekvienam pavyzdžiui
- **Modulių README** – tyrimo paskatos po kodo pavyzdžių

**Kaip naudoti:** atidarykite bet kurį kodo failą ir užduokite Copilot siūlomus klausimus. Jis turi visą kodo bazės kontekstą ir gali paaiškinti, išplėsti ar pasiūlyti alternatyvas.
...
MIT licencija - žr. [LICENSE](../../LICENSE) failą platesnei informacijai.
