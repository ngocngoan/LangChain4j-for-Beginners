...
**Нови сте у LangChain4j?** Погледајте [Глосар](docs/GLOSSARY.md) за дефиниције кључних термина и концепата.
...
3. [Дизајн упита](02-prompt-engineering/README.md) - Савладајте ефективно креирање упита
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Правите интелигентне системе засноване на знању
5. [Алатке](04-tools/README.md) - Интегришите екстерне алате и једноставне асистенте
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Радите са Model Context Protocol (MCP) и Agentic модулима
---
...
3. Користите подразумеване опције – одабраће се Development контејнер направљен за овај курс
...
> **Напомена:** Ова обука користи и GitHub моделе и Azure OpenAI. Модул [Брзи почетак](00-quick-start/README.md) користи GitHub моделе (није потребна Azure претплата), док модули 1-5 користе Azure OpenAI. Започните са [БЕСПЛАТНИМ Azure налогом](https://aka.ms/azure-free-account) ако га немате.


## Учење са GitHub Copilot-ом

Да бисте брзо почели са кодирањем, отворите овај пројекат у GitHub Codespace-у или вашем локалном IDE-ју са обезбеђеним devcontainer-ом. Devcontainer који се користи у овом курсу долази преформатиран са GitHub Copilot-ом за AI парно програмирање.

Сваки пример кода укључује предложена питања која можете поставити GitHub Copilot-у да проширите своје разумевање. Потражите упутства са 💡/🤖 у:

- **Заглављима Java фајлова** - Питања специфична за сваки пример
- **README фајловима модула** - Потражите питања након примера кода

**Како користити:** Отворите било који фајл са кодом и поставите предложена питања Copilot-у. Он има пун контекст базе кода и може објаснити, проширити и предложити алтернативе.
...
### Сериија за генеритивни AI
[![Генеритивни AI за почетнике](https://img.shields.io/badge/Generative%20AI%20for%20Beginners-8B5CF6?style=for-the-badge&labelColor=E5E7EB&color=8B5CF6)](https://github.com/microsoft/generative-ai-for-beginners?WT.mc_id=academic-105485-koreyst)
[![Генеритивни AI (.NET)](https://img.shields.io/badge/Generative%20AI%20(.NET)-9333EA?style=for-the-badge&labelColor=E5E7EB&color=9333EA)](https://github.com/microsoft/Generative-AI-for-beginners-dotnet?WT.mc_id=academic-105485-koreyst)
[![Генеритивни AI (Java)](https://img.shields.io/badge/Generative%20AI%20(Java)-C084FC?style=for-the-badge&labelColor=E5E7EB&color=C084FC)](https://github.com/microsoft/generative-ai-for-beginners-java?WT.mc_id=academic-105485-koreyst)
[![Генеритивни AI (JavaScript)](https://img.shields.io/badge/Generative%20AI%20(JavaScript)-E879F9?style=for-the-badge&labelColor=E5E7EB&color=E879F9)](https://github.com/microsoft/generative-ai-with-javascript?WT.mc_id=academic-105485-koreyst)
...
Овај документ је преведен коришћењем AI сервиса за превођење [Co-op Translator](https://github.com/Azure/co-op-translator). Иако се трудимо да обезбедимо тачност, молимо вас да имате у виду да аутоматски преводи могу да садрже грешке или нетачности. Оригинални документ на изворном језику треба сматрати ауторитетним извором. За критичне информације препоручује се професионалан превод од стране стручних лингвиста. Нисмо одговорни за било каква неспоразума или погрешна тумачења настала употребом овог превода.
