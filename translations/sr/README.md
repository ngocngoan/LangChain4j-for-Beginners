...
Курс за израду AI апликација уз LangChain4j и Azure OpenAI GPT-5.2, од основног ћаскања до AI агената.

**Ново у LangChain4j?** Погледајте [Глоссар](docs/GLOSSARY.md) за дефиниције кључних термина и концепата.

## Садржај

1. [Брзи почетак](00-quick-start/README.md) - Започните са LangChain4j
2. [Увод](01-introduction/README.md) - Учење основе LangChain4j
3. [Prompt инжењеринг](02-prompt-engineering/README.md) - Мајсторско креирање ефикасних упита
4. [RAG (Retrieval-Augmented Generation)](03-rag/README.md) - Израђивање интелигентних система заснованих на знању
5. [Алати](04-tools/README.md) - Интеграција спољних алата и једноставних асистената
...
3. Користите подразумеване поставке – одабраће се развојно окружење направљено за овај курс
4. Кликните **Create codespace**
5. Саачекајте 5-10 минута да се окружење припреми
6. Одмах приступите [Брзом почетку](./00-quick-start/README.md) да започнете!

Након завршетка модула, истражите [Водич за тестирање](docs/TESTING.md) да видите концепте тестирања LangChain4j у акцији.

> **Напомена:** Ова обука користи и GitHub моделе и Azure OpenAI. Модул [Брзог почетка](00-quick-start/README.md) користи GitHub моделе (није потребна Azure претплата), док модули 1-5 користе Azure OpenAI. Ако немате налог, започните са [БЕСПЛАТНИМ Azure налогом](https://aka.ms/azure-free-account).


## Учење уз GitHub Copilot

Да бисте брзо почели са кодирањем, отворите ovaj пројекат у GitHub Codespace-у или у свом локалном IDE-ју са обезбеђеним devcontainer-ом. Devcontainer који се користи у овом курсу је унапред конфигурисан са GitHub Copilot-ом за AI парно програмирање.
...
- **Заглављима Java датотека** - Питања специфична за сваки пример
- **Module README-има** - Подстицаји за истраживање након примера кода

**Како користити:** Отворите било коју код датотеку и постављајте Copilot-у предложена питања. Он има пун контекст базе кода и може објаснити, проширити и предложити алтернативе.
