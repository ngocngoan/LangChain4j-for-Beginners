...
Курс за прављење AI апликација са LangChain4j и Azure OpenAI GPT-5.2, од основних ћаскања до AI агената.
...
> **Препоручено је да клонирате локално?**
>
...
5. [Алати](04-tools/README.md) - Интегришите екстерне алате и једноставне асистенте
6. [MCP (Model Context Protocol)](05-mcp/README.md) - Рад са Model Context Protocol (MCP) и Agentic модулима
---

## Пут учења

**Нов у LangChain4j?** Погледајте [Глосаријум](docs/GLOSSARY.md) за дефиниције кључних термина и појмова.

> **Брзи почетак**

1. Форкујте овај репозиторијум на ваш GitHub налог
2. Кликните **Code** → картицу **Codespaces** → **...** → **New with options...**
3. Користите подразумеване опције – ово ће изабрати Development контейнер креиран за овај курс
...
> **Напомена:** Овај тренинг користи и GitHub Моделе и Azure OpenAI. Модул [Брзи почетак](00-quick-start/README.md) користи GitHub Models (није потребна Azure претплата), док модули 1-5 користе Azure OpenAI. Почните са [БЕСПЛАТНИМ Azure налогом](https://aka.ms/azure-free-account) ако га немате.


## Учење уз GitHub Copilot

Да бисте брзо почели са програмирањем, отворите овај пројекат у GitHub Codespace-у или вашем локалном IDE помоћу обезбеђеног devcontainer-а. Девкантејнер који се користи у овом курсу је унапред конфигурисан са GitHub Copilot-ом за AI упарено програмирање.

Свaki пример кода садржи предлоге питања која можете поставити GitHub Copilot-у да продубите своје разумевање. Потражите 💡/🤖 подсетнике у:

- **Java заглавља фајлова** - Питања специфична за сваки пример
- **Module README-ови** - Подстицаји за даље истраживање после примера кода

**Како користити:** Отворите било који фајл са кодом и поставите Copilot-у предложена питања. Има потпуни контекст базе кода и може објашњавати, проширивати и предлагати алтернативе.

Желите да сазнате више? Погледајте [Copilot за AI упарено програмирање](https://aka.ms/GitHubCopilotAI).
...
Ако запнете или имате било каква питања о изградњи АИ апликација, придружите се:
...
Овај документ је преведен коришћењем ИИ услуге превођења [Co-op Translator](https://github.com/Azure/co-op-translator). Док се трудимо да обезбедимо прецизност, молимо вас да имате на уму да аутоматски преводи могу садржати грешке или нетачности. Оригинални документ на његовом изворном језику треба сматрати ауторитетним извором. За критичне информације препоручује се професионални људски превод. Нисмо одговорни за било каква неспоразума или погрешне тумачења настале коришћењем овог превода.
