...
- [Run the Examples](#run-the-examples)
  ...
  - [4. Document Q&A (Easy RAG)](#4-document-qa-easy-rag)
...
This quick start uses three Maven dependencies in the [`pom.xml`](pom.xml):
...
**Document Q&A (Easy RAG)** - [SimpleReaderDemo.java](src/main/java/com/example/langchain4j/quickstart/SimpleReaderDemo.java)
